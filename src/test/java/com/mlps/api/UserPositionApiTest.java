...
public class UserPositionApiTest extends BaseTest {

	@Test
	public void retrieveUserInfoListTest() throws Exception {
		Long timestamp = new Date().getTime();
		mockMvc.perform((post("/api/userPosition/saveUserPosition")
				.param("longitude","683409")
				.param("Latitude","683409")
				.param("position","683409")
				.param("timestamp", timestamp+"")
				.param("sign", Encrypter.md5s("683409683409" + timestamp +
