...
function(XHEDITOR, $, undefined) {
	...
	Xheditor = function(textarea, options) {
		...
		function checkFileExt(e, t) {
			return "*" === t || e.match(RegExp(".(" + t.replace(/,/g, "|") + ")$", "i")) ? !0: (utils.warningTip(getLang("upload.extLimit", t)), !1)
		}
		...
		this.init = function() {
			function e(e) {
				var t,
				i = $(e.target); (t = i.css("width")) && i.css("width", "").attr("width", t.replace(/[^0-9%]+/g, "")),
			...
			var a,
			n,
			o = settings.background || _text.style.background,
			...
			function(e) {
				...
				if (s && (i = s.files) && i.length > 0) {
					...
					n,
					o,
					l = ["Link", "Img", "Flash", "Media"],
					r = [];
					for (a in l) n = l[a],
					settings["up" + n + "Url"] && settings["up" + n + "Url"].match(/^[^!].*/i) && r.push(n + ":," + settings["up" + n + "Ext"]);
					return 0 === r.length ? !1: (o = r.join(","), n = t(i), 1 === n ? utils.warningTip(getLang("upload.extLimit", o.replace(/\w+:,/g, ""))) : 2 === n ? utils.warningTip(getLang("upload.typeLimit")) : n && _this.startUpload(i, settings["up" + n + "Url"], "*",
					function(e) {
						var t,
						i = [],
						s = settings.onUpload;
						s && s(e);
						for (var a = 0, o = e.length; o > a; a++) t = e[a],
		...
		this.cleanWord = function(e) {
			...
			if (i > 0 && 3 > i && /mso(-|normal)|WordDocument|<table\s+[^>]*?x:str|\s+class\s*=\s*"?xl[67]\d"/i.test(e)) {
				...
				function(e, t) {
					var i,
					s = '<img src="' + editorRoot + "xheditor_skin/blank.gif" + '" _xhe_temp="true" class="wordImage"';
		...
		this.formatXHTML = function(e, t) {
			...
			for (var k, C, T, S, $, F, L, j = 0, M = -1, E = "body", P = !1; k = x.exec(e);) C = k.index,
			...
			h.click(function() {
				...
				if (("" === e || 0 === n.length) && _this._exec("unlink"), "" !== e && "http://" !== e) {
					...
					if (t.length > 1) {
						...
						h += ">xhe_tmptext</a>",
						s = "" !== c ? c: s ? s: e;
						for (var u = 0, p = t.length; p > u; u++) e = t[u],
		...
		this.startUpload = function(fromFiles, toUrl, limitExt, onUploadComplete) {
			function onUploadCallback(sText, bFinish) {
				...
				bOK = !1;
				try {
//				        if(sText.indexOf('<pre>') != -1 ){
//				        	sText = sText.substring(5, sText.length-6);
//				        }
					data = eval("(" + sText + ")")
				} catch(ex) {}
				var alertMsg = '活动详情存在单张图片大于1M,请减小图片大小再提交！';
				...
				return data.err === undefined || data.msg === undefined ? utils.warningTip(alertMsg) : data.err ? utils.warningTip(alertMsg) : (arrMsg.push(data.msg), bOK = !0),
			...
			if (!isOpera && bHtml5Upload && (!fromFiles.nodeType || (fileList = fromFiles.files) && fileList[0].name)) {
				...
				var i,
				len = fileList.length;
				if (len > upMultiple) return utils.warningTip(getLang("upload.countLimit", upMultiple)),
				undefined;
		...
		this.html5Upload = function(e, t, i, s, a) {
			...
			for (var l, r = 0, h = t.length, c = 0, d = 0, u = this, p = 0; h > p; p++) d += t[p].size;
			this.remove = function() {
				l && (l.abort(), l = null)
			},
		...
		this.exec = function(e) {
			...
			case "cut":
				try {
					...
					utils.warningTip(getLang("cutDisabledTip"))
				}
				break;
			case "copy":
				try {
					...
					utils.warningTip(getLang("copyDisabledTip"))
				}
				break;
			case "paste":
				try {
					...
					utils.warningTip(getLang("pasteDisabledTip"))
				}
				break;
			case "pastetext":
