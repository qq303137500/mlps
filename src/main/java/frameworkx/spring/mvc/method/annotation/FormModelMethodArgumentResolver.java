package frameworkx.spring.mvc.method.annotation;
...
import frameworkx.spring.mvc.bind.annotation.FormModel;
import frameworkx.spring.mvc.util.MapWapper;
...
/**
     ...
     * with request values via data binding and optionally validated if {@code
            ...
            WebDataBinderFactory binderFactory) throws Exception
    {
        ...
        target = binder.convertIfNecessary(binder.getTarget(), parameter
                .getParameterType());
            ...
            throws Exception
    {
        ...
        ServletRequest servletRequest = prepareServletRequest(binder
                .getTarget(), request, parameter);
            ...
            for (Object key : servletRequest.getParameterMap().keySet())
            {
                ...
                { // bind simple type
                    ...
                    { // 处理如 array[0]=1&array[1]=2的情况
                        ...
                        targetList.set(index, simpleBinder.convertIfNecessary(
                    ...
                    if (component != null)
                    {
                        ...
                        if (componentBinder.getBindingResult().hasErrors())
                        {
                            if (isBindExceptionRequired(componentBinder,
                                    parameter))
                            {
                                throw new BindException(componentBinder
                                        .getBindingResult());
                            }
                        }
            ...
            NativeWebRequest request, MethodParameter parameter)
    {
                ...
                .entrySet())
        {
            ...
            {
                mockRequest.setParameter(getNewParameterName(parameterName,
                        modelPrefixName), value);
            }
        }
     ...
     * on bind or validation errors. The default implementation returns {@code
     * true} if the next method argument is not of type
     * {@link org.springframework.validation.Errors}.
     * 
     * @param binder
